                    ...
                    child: Column(
                      children: [
                        ...
                        FullWidthButtonWithIcon(
                          ...
                          onTap: (){
                            Navigator.of(context).push(MaterialPageRoute(builder: (context) => AddDateTimeScreen()));
                            },
                        )
                      ],
                    ),
    ...
    return
        Column(
          children: [
            CustomInkWell(
                onTap: (){
                  Navigator.of(context).push(MaterialPageRoute(builder: (context) => AddLocationScreen()));
                },
